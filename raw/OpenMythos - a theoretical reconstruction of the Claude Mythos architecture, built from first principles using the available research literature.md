...
](https://twitter.com/kyegomezb/)[

](https://discord.gg/3keGBK9Pvr)[
...
The training script for the 3B model on FineWeb-Edu is at [`training/3b_fine_web_edu.py`](https://github.com/kyegomez/OpenMythos/blob/main/training/3b_fine_web_edu.py).
...
| [`docs/datasets.md`](https://github.com/kyegomez/OpenMythos/blob/main/docs/datasets.md) | Recommended training datasets with token budget guidance per model size |
...
- On the Looped Transformers Controversy by ChrisHayduk: [https://x.com/ChrisHayduk/status/2045947623572688943](https://x.com/ChrisHayduk/status/2045947623572688943)
- On the Looped Transformers Controversy Summary by @realsigridjin [https://x.com/realsigridjin/status/2046012743778766875](https://x.com/realsigridjin/status/2046012743778766875)
...
- Mixture-of-Depths Attention: [https://arxiv.org/abs/2603.15619](https://arxiv.org/abs/2603.15619)
- Hyperloop Transformers: [https://arxiv.org/abs/2604.21254](https://arxiv.org/abs/2604.21254)
- The Recurrent Transformer: Greater Effective Depth and Efficient Decoding: [https://arxiv.org/abs/2604.21215](https://arxiv.org/abs/2604.21215)
